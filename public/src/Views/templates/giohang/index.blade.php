                            ...
                            @foreach(Cart::content() as $k => $v)
                                ...
                                <div class="procart flex items-start justify-between procart-{{ $v->rowId }}">
                                    <div class="pic-procart">
                                        <a class="text-decoration-none" href="{{ url('slugweb',['slug'=>$proInfo->slugvi]) }}" target="_blank" title="{{ $proInfo['name'.$lang] }}">
                                            <img src="{{ assets_photo('product','100x100x1',$proInfo->photo,'thumbs') }}" alt="{{ $proInfo['name'.$lang] }}" />
                                        </a>
                                    ...
                                    <div class="info-procart">
                                        <h3 class="name-procart"><a class="text-decoration-none" href="{{ url('slugweb',['slug'=>$proInfo->slugvi]) }}" target="_blank" title="{{ $proInfo['name'.$lang] }}">{{ $proInfo['name'.$lang] }}</a></h3>
                        ...
                        <div class="section-cart">
                            ...
                            <div class="information-cart">
                                ...
                                <div class="payments-cart form-check" >
                                    ...
                                    <label class="payments-label form-check-label"   for="payments-{{ $v->id }}" data-payments="{{ $v->id }}">{{ $v['name'.$lang] }}</label>
                                    <div class="payments-info payments-info-{{ $v->id }} transition">{!! nl2br($v['desc'.$lang]) !!}</div>
                                </div>
                                @endforeach
                            </div>
