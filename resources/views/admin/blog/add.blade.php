<x-layout bodyClass="g-sidenav-show  bg-gray-200">
  ...
  <main class="main-content position-relative max-height-vh-100 h-100 border-radius-lg ">
    <x-navbars.navs.auth titlePage="Thêm bài viết"></x-navbars.navs.auth>
      ...
      <div class="row">
        <div class="col-12 col-lg-10 m-auto">
          <div class="card">
            ...
            @endif
            <div class="card-body">
              <form method="POST" action="{{url('admin/bai-viet-add')}}" class="d-flex flex-column align-items-center" enctype="multipart/form-data">
                @csrf
