<x-layout bodyClass="g-sidenav-show  bg-gray-200">
  <x-navbars.staffsidebar activePage='staff/othertyre'></x-navbars.staffsidebar>
  <main class="main-content position-relative max-height-vh-100 h-100 border-radius-lg ">
    <x-navbars.navs.auth titlePage="Lốp xe nhãn hiệu khác"></x-navbars.navs.auth>
    <div class="container-fluid py-4">
      <div class="row mt-4">
        <div class="col-12">
          <div class="card">
            <div class="card-header">
              <h5 class="mb-0">Lốp xe nhãn hiệu khác</h5>
            </div>
            ...
            <div class="d-sm-flex bg-gray-100 border-radius-lg p-2 my-4">
              ...
              <form method="POST" action="{{url('staff/trazano')}}" enctype="multipart/form-data">
                @csrf
            ...
            <div class="table-responsive">
              <div class="dataTable-wrapper dataTable-loading no-footer sortable searchable fixed-height fixed-columns">
                <div class="dataTable-container"><table class="table table-flush dataTable-table" id="datatable-basic">
                    ...
                    <tbody>
                      @foreach ($othertyres as $key => $tyre)
                      <tr>
