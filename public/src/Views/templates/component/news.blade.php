                ...
                @foreach ($newsnb as $k => $value)
                    <div class="newsnb-box hover-box">
                        <div class="newsnb-image">
                            <a class="scale-img hover-img" href="{{ url('slugweb',['slug'=>$value['slugvi']]) }}" title="{{ $value['name'.$lang] }}">
                        ...
                        <div class="newsnb-info hover-info">
                            <a class="text-decoration-none" href="{{ url('slugweb',['slug'=>$value['slugvi']]) }}">
                                <h3 class="hover-main text-split">{{ $value['name'.$lang] }}</h3>
                                <p class="hover-main text-split">{{ $value['desc'.$lang] }}</p>
