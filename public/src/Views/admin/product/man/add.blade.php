                            ...
                            <div class="card mb-4 form-group-category">
                                ...
                                <div class="card-body">
                                    ...
                                    @if (!empty($configMan->tags))
                                        ...
                                        */ ?>
                                        <div class="form-group last:!mb-0">
                                            <label class="form-label" for="id_tags">Danh mục hãng:</label>
                                            {!! Func::getTags(@$item['id'], 'dataBrand', 'product_tags', $type.'-brand') !!}
                                        </div>
                                        <div class="form-group last:!mb-0">
                                            <label class="form-label" for="id_tags">Danh mục size:</label>
                                            {!! Func::getTags(@$item['id'], 'dataSize', 'product_tags', $type.'-size') !!}
                                        </div>
                                        <div class="form-group last:!mb-0">
                                            <label class="form-label" for="id_tags">Danh mục mã:</label>
                                            {!! Func::getTags(@$item['id'], 'dataCode', 'product_tags', $type.'-code') !!}
                                        </div>
                                        <div class="form-group last:!mb-0">
                                            <label class="form-label" for="id_tags">Danh mục loại:</label>
                                            {!! Func::getTags(@$item['id'], 'dataType', 'product_tags', $type.'-type') !!}
                                        </div>
                                    @endif
