...
NN_FRAMEWORK.Menu = function () {
    ...
    $(window).scroll(function(){
        if($(window).scrollTop() >= $(".header").height()) $(".menu").addClass('header-fix');
        else $(".menu").removeClass('header-fix');
    });
	/* Menu fixed */
	$(window).scroll(function () {
...
NN_FRAMEWORK.Recaptcha = function () {
	grecaptcha.ready(function () {
		...
		if (isExist($('.form-newsletter'))) {
			/* Contact */
			generateCaptcha('newsletters', 'recaptchaResponseContact');
		}
	});
};
...
NN_FRAMEWORK.customJS = function () {
	...
	if (isExist($('.hinhanh-slide'))) {
		$('.hinhanh-slide').slick({
		  	dots: false,
		  	infinite: true,
		  	speed: 1000,
		  	arrows:true,
		  	appendArrows:$('.hinhanh-arr'),
		  	nextArrow:'<div class="hinhanh-next"><img src="assets/images/hinhanh-next.png" alt=""></div>',
	      	prevArrow:'<div class="hinhanh-prev"><img src="assets/images/hinhanh-prev.png" alt=""></div>',
		  	slidesToShow: 2,
		  	centerMode:true,
		  	centerPadding:'95px',
		  	autoplay:true,
