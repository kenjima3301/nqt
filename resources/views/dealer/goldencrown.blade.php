<x-layout bodyClass="g-sidenav-show  bg-gray-200">
  <x-navbars.dealersidebar activePage='staff/goldencrown'></x-navbars.dealersidebar>
  <main class="main-content position-relative max-height-vh-100 h-100 border-radius-lg ">
    <x-navbars.navs.auth titlePage="Golden Crown"></x-navbars.navs.auth>
    <div class="container-fluid py-4">
      <div class="row mt-4">
        <div class="col-12">
          <div class="card">
            <div class="card-header">
              <h5 class="mb-0">Lốp xe Golden Crown</h5>
            </div>
            ...
            <div class="d-sm-flex bg-gray-100 border-radius-lg p-2 my-4">
              ...
              <form method="POST" action="{{url('dealer/goldencrown')}}" enctype="multipart/form-data">
                @csrf
