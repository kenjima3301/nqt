...
@section('content')
    <section x-data>
        <div class="wrap-main my-[20px] mx-auto max-w-[1200px] w-[calc(100%_-_20px)] py-5">
            <h2 class="title-pro-detail capitalize text-[25px] py-[10px] block">{{ $rowDetail['name'.$lang] }}</h2>
            <div class="grid-pro-detail">
                <div class="left-pro-detail">
                    <div class="slick_photo1  overflow-hidden">
                        <a id="Zoom-1" class="MagicZoom"
                            ...
                            <img class=""
                                onerror="this.src='{{ thumbs('thumbs/600x600x2/assets/images/noimage.png') }}';"
                                src="{{ assets_photo('product', '600x600x2', $rowDetail['photo'], 'watermarks') }}"
                    ...
                    <div class="album-product my-2 mt-3">
                        <div class="slick in-page" data-dots="0" data-infinite="0" data-arrows="0" data-autoplay='0'
                            ...
                            <a class="thumb-pro-detail border-[1px]  mx-2" data-zoom-id="Zoom-1"
                                ...
                                data-image="{{ assets_photo('product', '600x600x2', $rowDetail['photo'], 'watermarks') }}"><img
                            ...
                            @foreach ($rowDetailPhoto??[] as $v)
                                <a class="thumb-pro-detail border-[1px] mx-2" data-zoom-id="Zoom-1"
                                    ...
                                    title="{{ $rowDetail['name'.$lang] }}"
                                    data-image="{{ assets_photo('product', '600x600x2', $v['photo'], 'watermarks') }}"><img
                                        class=" !mb-0 !pb-0 !border-0"
                                        onerror="this.src='{{ thumbs('thumbs/600x600x2/assets/images/noimage.png') }}';"
                                        src="{{ assets_photo('product', '600x600x2', $v['photo'], 'watermarks') }}"
                                        alt="{{ $rowDetail['name'.$lang] }}"></a>
                            @endforeach
                        </div>
                    </div>
                ...
                <div class="right-pro-detail">
                    ...
                    */ ?>
                    <?php /*
                    <div class="descvi-pro">{!! Func::decodeHtmlChars($rowDetail['desc'.$lang]??'') !!}</div>
                    */ ?>
                    <div class="share">
                        <b>Chia sẻ:</b>
